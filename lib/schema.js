...
module.exports = exports = function (options) {
    ...
    return Object.create(methods, helper.ownProperties({
        attributes: {},
        table: options.table || '',
        hashKeyAttributes: normalizeKey(key.hash),
        hashKey: this.hashKeyAttributes.join(Schema.keyDelimiter),
        rangeKeyAttributes: normalizeKey(key.range),
        rangeKey: this.rangeKeyAttributes ? this.rangeKeyAttributes.join(Schema.keyDelimiter) : null,
