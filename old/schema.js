...
var methods = {
    ...
    createTable: function (options, callback) {
        ...
        if (self.hasSecondaryAttributes())
        {
            ...
            _.forEach(self.secondaryKeyAttributes, function(attr){
    ...
    deleteTable: function(callback) {
        ...
        connection.client.deleteTable(params, callback);
    },
    ...
    getSerializedAttributes: function () {
        ...
        {
            _.forEach(self.hashKeyAttributes, function(attr){
                delete attrs[attr];
            });
        ...
        {
            _.forEach(self.rangeKeyAttributes, function(attr){
                delete attrs[attr];
            });
